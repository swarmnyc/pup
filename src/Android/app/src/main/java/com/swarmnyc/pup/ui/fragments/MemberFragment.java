...
public class MemberFragment extends Fragment {
        ...
        m_lobbyService.leave(
                m_lobby.getId(), new ServiceCallback<String>() {
                    ...
                    public void success(final String value) {
                        //showUndo();
                        m_lobbyService.removeUser(m_lobby, User.current);
                        EventBus.getBus().post(new AfterLeaveLobbyEvent(m_lobby.getId()));
                    }
                }
        );
    }
    ...
    @Subscribe
    public void postUserChanged(LobbyUserChangeEvent event) {
