...
import com.swarmnyc.pup.ui.adapters.LobbyAdapter;
...
public class LobbyListFragment extends BaseFragment {
    ...
    private void reloadData(final boolean restart) {
        ...
        {
            com.swarmnyc.pup.ui.ViewAnimationUtils.hideWithAnimation(getActivity(), m_emptyResults);
        }
                ...
                m_lobbyFilter, new ServiceCallback<LobbySearchResult>() {
                    ...
                    public void success(LobbySearchResult result) {
                        ...
                        if (restart && result.getResult().size() == 0) {
                            ...
                            ViewAnimationUtils.showWithAnimation(getActivity(), m_emptyResults);
                        } else if(m_emptyResults.getVisibility() == View.VISIBLE) {
                            ViewAnimationUtils.hideWithAnimation(getActivity(), m_emptyResults);
                        }
                    }
                    ...
                    public void failure(String message) {
                        ...
                        if (m_lobbyAdapter.getItemCount() == 0) {
                            ViewAnimationUtils.showWithAnimation(
