...
namespace SWARM.PuP.Web.ApiControllers
{
    ...
    public class OldAccountController : ApiController
    {
        ...
        public OldAccountController(PuPUserManager userManager,
        ...
        public PuPUserManager UserManager
        {
            get
            {
                return _userManager ?? Request.GetOwinContext().GetUserManager<PuPUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            PuPUser user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = PuPOAuthProvider.CreateProperties(user);
